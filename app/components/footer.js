  ...
  */
    ...
    <footer className="pb-4 text-gray-200">
      <div className="max-w-5xl xl:max-w-5xl mx-auto divide-y divide-gray-900 px-4 sm:px-6 md:px-8">
        <ul className="text-sm font-medium sm:pb-20 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-10 mt-16">
          <li className="space-y-5 row-span-2">
            <h2 className="text-2xl tracking-wide text-white">ReVint</h2>
