  ...
  return (
    <>
      <div className='items-auto relative'>
        <div className="ml-4 md:ml-96 mt-16 md:mt-64 absolute items-center justify-center text-center" style={{ zIndex: 1 }}>
          <Typography variant='h1' className="text-4vw md:text-9vw">
            <WordTransition />
          </Typography>
          <Typography variant="h3" className="mt-4 text-2vw md:text-3vw lg:text-4vw">
        ...
        <div className="bg-cover bg-full h-full min-h-screen flex rounded" style={{ backgroundImage: 'url(/4.jpg)' }}>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg -mt-16">
                  ...
                  <div className="px-4 py-5 flex-auto">
                    <h6 className="text-xl font-semibold text-black">Create your own products</h6>
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg  -mt-24">
                  <div className="flex justify-center ">
                    <div className="-mt-8 rounded-full p-4 shadow-md bg-brown">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="" color="black" stroke="currentColor" strokeWidth="1" className="h-7 w-8">
                        <path fill="#00000" d="M21.886 5.115c3.521 0 6.376 2.855 6.376 6.376 0 1.809-0.754 3.439-1.964 4.6l-10.297 10.349-10.484-10.536c-1.1-1.146-1.778-2.699-1.778-4.413 0-3.522 2.855-6.376 6.376-6.376 2.652 0 4.925 1.62 5.886 3.924 0.961-2.304 3.234-3.924 5.886-3.924zM21.886 4.049c-2.345 0-4.499 1.089-5.886 2.884-1.386-1.795-3.54-2.884-5.886-2.884-4.104 0-7.442 3.339-7.442 7.442 0 1.928 0.737 3.758 2.075 5.152l11.253 11.309 11.053-11.108c1.46-1.402 2.275-3.308 2.275-5.352 0-4.104-3.339-7.442-7.442-7.442v0z"></path>
                      </svg>
                    </div>
                  </div>
                  <div className="px-4 py-5 flex-auto">
                    <h6 className="text-xl font-semibold text-black">
                      Like products that you like                    </h6>
                    <p className="mt-2 mb-4 text-black">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto bg-black/25 rounded-xl">
                ...
                <p className="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                  We are also concerned about the environment, that's why we want to help people to recycle their clothes and give them a second life.
                  So we encourage you to buy and sell your clothes in our website.
                </p>
                <a
        ...
        {/* <div className="bg-cover bg-full h-full min-h-screen flex rounded" style={{ backgroundImage: 'url(/clothes.jpeg)' }}>
          <div className="bg-cover bg-left w-1/3 bg-black/25">
            <div className="bg-vintage-pattern text-white p-8">
              <div className="relative h-full w-full">
                <div className="absolute inset-0 grid h-full w-full place-items-center bg-black/75">
                  <div className="w-3/4 text-right md:w-/4">
                    <Typography variant="h1" color="white" className="mb-4 text-3xl md:text-4xl lg:text-5xl mt-16">
                      Recycle Your Clothes
                    </Typography>
                    <Typography variant="lead" color="white" className="mb-12 opacity-80 drop-shadow-2xl text-xl bg-black/20">
