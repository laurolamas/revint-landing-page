  ...
  return (
    <>
      <div className='h-screen v-screen items-auto relative'>
        ...
        <div className="h-2/6 flex-row bg-marron/50">
          <div className=" mx-auto md:px-6">
            <section className=" text-center">
              <h2 className="mb-20 text-5xl font-serif font-semibol text-brown">Features</h2>
              <div className="grid lg:grid-cols-3 lg:gap-x-12">
                <div className=" lg:mb-0">
                  <div
                    className="block h-full rounded-xl bg-fack">
                    ...
                    <div className="p-6">
                      <h5 className="mb-4 text-lg font-semibold text-black">Create your own products</h5>
                      <p>
        ...
        <div className="h-full bg-cover bg-center opacity-80 mb-20 bg-fack">
          <div className='bg-black h-auto w-full flex-col'>
            <div className="h-1/2 items-center mb-12 ">
              <Typography variant="h1" color="white" className=" flex items-center text-2xl justify-start mb-12">
                About us
              </Typography>
              <Typography variant="lead" className="justify-start text-xl w-1/3">We are software development students who been motivated by the non-existent or non-functional online vintage stores in Uruguay. Our mindset is letting users to feel free by selling their products, the goal is connect those users with people who would want to buy them.</Typography>
            </div>
          </div>
          <h1 className="text-3xl text-semibold border-t-4 border-beige flex items-center justify-center">
            Our team
          </h1>
          <div className="w-full justify-evenly flex mb-32 bg-beige">
            <div className=" w-96 ">
              <figure className="px-10 pt-10">
                <img src="./igni.jpg" alt="foto" className="rounded-xl" />
              </figure>
            ...
            <div className="w-96">
              <figure className="px-10 pt-10">
                <img src="./ale.jpeg" alt="foto" className="rounded-xl" />
              </figure>
